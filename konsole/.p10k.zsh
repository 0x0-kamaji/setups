# Generated by Powerlevel10k configuration wizard on 2025-09-01 at 23:01 BST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 13396.
# Wizard options: compatible, classic, unicode, darkest, blurred heads, blurred tails,
# 2 lines, dotted, full frame, compact, concise, transient_prompt,
